//
//  Carruseles2ViewController.swift
//  Toolbox Test
//
...
class Carruseles2ViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, UIScrollViewDelegate {
...
//MARK: - UI -
extension Carruseles2ViewController {
    
    func setupUI() {
        titleLabel.text = carruseles[counter].title
        
        collectionView.delegate = self
        collectionView.dataSource = self
        
        self.collectionView!.register(CarruselCell.self, forCellWithReuseIdentifier: "cell")
...
extension Carruseles2ViewController {
    ...
    @IBAction func nextAction(_ sender: Any) {
        ...
        if (counter + 1 == carruseles.count) {
            ...
            counter = 0
            self.performSegue(withIdentifier: "goCarruseles", sender: nil)
        } else {
...
extension Carruseles2ViewController {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "cell", for: indexPath) as! CarruselCell
